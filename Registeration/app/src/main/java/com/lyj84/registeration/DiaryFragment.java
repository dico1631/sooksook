...
public class DiaryFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments() != null) {
            ...
            final Button firstButton =(Button)getView().findViewById(R.id.firstButton);
            final Button secondButton =(Button)getView().findViewById(R.id.secondButton);
            //버튼에 fragment 관련 코드들 작성해야함.
        }
    }
